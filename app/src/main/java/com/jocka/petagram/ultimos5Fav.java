...
public class ultimos5Fav extends AppCompatActivity {
    ...
    public void initListaMascotas2(){
        ...
        mascota m1 = new mascota("Oso", 0, R.drawable.bull_terrier);
        mascota m2 = new mascota("Bobby", 0, R.drawable.pitbull_cachorro);
        mascota m3 = new mascota("Laika", 0, R.drawable.doberman_cachorro);
        mascota m4 = new mascota("Rufo", 0, R.drawable.rottweiler_cachorro);
        mascota m5 = new mascota("Luco", 0, R.drawable.golden_retriever);
