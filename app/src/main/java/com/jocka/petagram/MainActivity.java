...
import com.jocka.petagram.mascota;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void initListaMascotas(){
        ...
        mascotas.add(new mascota("Oso", 0, R.drawable.bull_terrier));
        mascotas.add(new mascota("Bobby", 0, R.drawable.pitbull_cachorro));
        mascotas.add(new mascota("Laika", 0, R.drawable.doberman_cachorro));
        mascotas.add(new mascota("Rufo", 0, R.drawable.rottweiler_cachorro));
        mascotas.add(new mascota("Luco", 0, R.drawable.golden_retriever));
